 ...
 * @Date: 2021-03-05 11:04:16
 * @Last Modified by: yuanxiongfeng
 * @Last Modified time: 2021-03-05 11:05:12
*/
  ...
  setup: () => {
    ...
    const toPostRequest = async () => {
      ...
      for (const el of list) {
        const { planId, projectId, instanceId, status, version } = el;
        const params = {
          planId,
          projectId,
          instanceId,
        ...
        await API.PASS_CASE(params, { headers });
        await sleep(3000);
        console.log("planId");
      }
    };
